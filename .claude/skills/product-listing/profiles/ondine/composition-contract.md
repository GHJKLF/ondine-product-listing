...
| `ondine_uk_numeric_size_identity_v1` | Preserve already-numeric UK sizes exactly after market/size-system proof. Letter sizes require the profile table and a separate mapping trace. |
