...
OUTPUT = HERE / "nobodys-child-calloway.fact-packet-projection-v3.expected.json"
CAPTURED_AT = "2026-09-01T11:35:24Z"
REVIEWED_AT = "2026-09-01T21:42:00+01:00"
...
profile_path = PROFILE.parent / "ondine.md"
prior_v2_manifest_path = HERE / "nobodys-child-calloway.fact-packet-projection-v2.expected.json"
prior_v2_reviewer_lock_path = HERE / "nobodys-child-calloway.fact-packet-projection-v2.atlas-lock.json"
...
PINNED = {
    ...
    profile_path: "e55ce269d910795d4ceff98e897ec5e879632bb4b2f9c41b4a2c863dcf07da59",
    prior_v2_manifest_path: "c588b0757be6acae56ff2e883432c281e1716b506a3050a905c526278a3e23ca",
    prior_v2_reviewer_lock_path: "cc4a4eb0f8e302d520b0e4b28679ff3351d3f791646de75befeb4a61fb0bf761",
}
...
prior_v2_manifest = load(prior_v2_manifest_path)
bindings = prior_v2_manifest["bindings"]
assert len(bindings) == 33
bindings_canonical_sha256 = canonical_sha(bindings)
assert bindings_canonical_sha256 == "7b89952844b9de29083fe5ec943adff7ed1fb23ab19a52a3987e0340bf95ce95"
length_binding = next(item for item in bindings if item["fact_packet_fact_id"] == "fp.length_class")
assert length_binding["allowed_transform_ids"] == ["ondine_tags_v1"]
...
for order, binding in enumerate(bindings, 1):
    ...
    unsupported_transform_ids = []
    projection_status = "ALLOW"
    records.append(
        {
            "order": order,
...
assert all(record["projection_status"] == "ALLOW" and record["block_reason"] is None for record in records)
assert all(
...
manifest = {
    "manifest_id": "nobodys-child-calloway-fact-packet-projection-oracle-v3",
    "schema_version": "3.0.0",
    "artifact_role": "SCOUT_AUTHORED_AUDITED_PRODUCT_SPECIFIC_PROJECTION_PENDING_DISTINCT_ATLAS_REVIEW",
    "status": "AWAITING_ATLAS_SIGNATURE",
    "supersedes": {
        "manifest_path": ".claude/skills/product-listing/tests/oracles/fact-packets/nobodys-child-calloway.fact-packet-projection-v2.expected.json",
        "manifest_sha256": "c588b0757be6acae56ff2e883432c281e1716b506a3050a905c526278a3e23ca",
        "reviewer_lock_path": ".claude/skills/product-listing/tests/oracles/fact-packets/nobodys-child-calloway.fact-packet-projection-v2.atlas-lock.json",
        "reviewer_lock_sha256": "cc4a4eb0f8e302d520b0e4b28679ff3351d3f791646de75befeb4a61fb0bf761",
        "prior_disposition": "SUPERSEDED_P0_MUTABLE_DOWNSTREAM_DEPENDENCY",
        "reason": "Vale found that v2 named mutable downstream contract/example consumers as inputs. V3 preserves v2 bindings but removes those circular dependencies.",
    },
    "actors": {
        "author_auditor": {
            "actor_id": "Scout",
    ...
    "fixture": {
        ...
        "source_capture_replay_implementation_lock": artifact(implementation_lock_path),
        "ondine_profile": artifact(profile_path),
    },
    "source_capture": {
    ...
    "projection_pins": {
        "source_capture_sha256": "279d3d4170cf62c02a140bd190aefe1fc1cded754041ad92ca0c2f88c802b660",
        "source_capture_determinism_sha256": "b39a7394ac9f66f2189b82acb121da8f2c878313a9bf63f1ac5a05723a3f7535",
        "ondine_profile_sha256": "e55ce269d910795d4ceff98e897ec5e879632bb4b2f9c41b4a2c863dcf07da59",
        "ordered_bindings_canonical_sha256": bindings_canonical_sha256,
    },
    "dependency_boundary": {
        "upstream_inputs_only": True,
        "downstream_consumers_are_not_inputs": [
            "composition_contract",
            "listing_plan_example",
            "listing_plan_composer",
            "listing_plan_validator",
        ],
        "mutable_downstream_path_or_hash_references_present": False,
    },
    "summary": {
